...
class DMN_batch:
    ...
    def _process_batch(self, _inputs, _questions, _answers, _fact_counts, _input_masks):
        ...
        zipped = list(zip(inputs, questions, answers, fact_counts, input_masks))
    ...
    def shuffle_train_set(self):
        ...
        combined = list(zip(self.train_input, self.train_q, self.train_answer, self.train_fact_count, self.train_input_mask))
        random.shuffle(combined)
        self.train_input, self.train_q, self.train_answer, self.train_fact_count, self.train_input_mask = list(zip(*combined))
